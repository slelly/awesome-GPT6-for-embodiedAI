...
def main() -> int:
    ...
    with sync_playwright() as pw:
        ...
        assert sum(item['status'] == 'verified' for item in publication_dates.values()) == 52
        ...
        assert len(expected['projects']) == 40 and len(expected['social']) == 15
        ...
        assert len(retained) == 55 and len(videos) == 21
