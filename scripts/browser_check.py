...
def main() -> int:
    ...
    with sync_playwright() as pw:
        ...
        assert page.locator('.card').count() == 17
        ...
        assert len(retained) == 31 and len(videos) == 17
        ...
        assert not errors, errors
        browser.close()
    print('PASS: no detail UI/keyboard/click hooks; all 31 sourced verified-or-explicitly-estimated publication displays, 17 first-frame video posters plus P09 text cover, video controls, search, groups, language, mobile, and Pages subpath work.')
    return 0
